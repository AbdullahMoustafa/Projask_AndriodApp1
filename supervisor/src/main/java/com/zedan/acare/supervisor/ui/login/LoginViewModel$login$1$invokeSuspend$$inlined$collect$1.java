...
public final class LoginViewModel$login$1$invokeSuspend$$inlined$collect$1 implements FlowCollector<LoginStatus> {
    final /* synthetic */ LoginViewModel$login$1 this$0;

    public LoginViewModel$login$1$invokeSuspend$$inlined$collect$1(LoginViewModel$login$1 loginViewModel$login$1) {
        this.this$0 = loginViewModel$login$1;
    }

    public Object emit(Object value, Continuation $completion) {
        Continuation continuation = $completion;
        this.this$0.this$0._statusLogin.postValue((LoginStatus) value);
