...
public abstract class Hilt_MessageDialogs extends DialogFragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_MessageDialogs(int contentLayoutId) {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((MessageDialogs_GeneratedInjector) generatedComponent()).injectMessageDialogs((MessageDialogs) UnsafeCasts.unsafeCast(this));
        }
    }
