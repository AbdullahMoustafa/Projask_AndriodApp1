...
final class LanguageBottomSheet$onViewCreated$2 implements View.OnClickListener {
    final /* synthetic */ LanguageBottomSheet this$0;

    LanguageBottomSheet$onViewCreated$2(LanguageBottomSheet languageBottomSheet) {
        this.this$0 = languageBottomSheet;
    }

    public final void onClick(View it) {
        this.this$0.selectedLangage = "en";
