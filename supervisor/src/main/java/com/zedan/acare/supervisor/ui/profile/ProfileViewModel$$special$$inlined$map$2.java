...
public final class ProfileViewModel$$special$$inlined$map$2<I, O> implements Function<ProfileResult, ProfileResult.Success> {
    public final ProfileResult.Success apply(ProfileResult it) {
        ProfileResult it2 = it;
        if (it2 instanceof ProfileResult.Success) {
            return (ProfileResult.Success) it2;
        }
        return null;
    }
}
