...
public abstract class Hilt_ForgetPasswordFragment extends Fragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((ForgetPasswordFragment_GeneratedInjector) generatedComponent()).injectForgetPasswordFragment((ForgetPasswordFragment) UnsafeCasts.unsafeCast(this));
        }
    }
