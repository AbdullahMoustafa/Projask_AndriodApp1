...
final class AddTaskFragment$addViewListener$1 implements View.OnClickListener {
    final /* synthetic */ AddTaskFragment this$0;

    AddTaskFragment$addViewListener$1(AddTaskFragment addTaskFragment) {
        this.this$0 = addTaskFragment;
    }

    public final void onClick(View it) {
        DatePickerACAREKt.showDate(this.this$0, new Function1<DatePickerACARE.DateData, Unit>(this) {
            final /* synthetic */ AddTaskFragment$addViewListener$1 this$0;
            ...
            public final void invoke(DatePickerACARE.DateData it) {
                ...
                AddTaskFragment.access$getBinding$p(this.this$0.this$0).inputStartTimeDate.setText(it.getDate());
            }
        });
    }
}
