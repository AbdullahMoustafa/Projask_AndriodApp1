...
final class AddTaskFragment$addViewListener$2 implements View.OnClickListener {
    final /* synthetic */ AddTaskFragment this$0;

    AddTaskFragment$addViewListener$2(AddTaskFragment addTaskFragment) {
        this.this$0 = addTaskFragment;
    }

    public final void onClick(View it) {
        TimePickerACAREKt.showTime(this.this$0, new Function1<TimePickerACARE.TimeData, Unit>(this) {
            final /* synthetic */ AddTaskFragment$addViewListener$2 this$0;
            ...
            public final void invoke(TimePickerACARE.TimeData it) {
                ...
                AddTaskFragment.access$getBinding$p(this.this$0.this$0).inputStartHourDate.setText(new StringBuilder().append(it.getHourOfDay()).append(':').append(it.getMinute()).toString());
            }
        });
    }
}
