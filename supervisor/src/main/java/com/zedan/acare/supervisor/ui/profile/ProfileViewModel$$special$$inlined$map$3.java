...
public final class ProfileViewModel$$special$$inlined$map$3<I, O> implements Function<ProfileResult.Success, RegisterParam> {
    public final RegisterParam apply(ProfileResult.Success it) {
        ProfileResult.Success it2 = it;
        if (it2 != null) {
            return it2.getSupervisor();
        }
        return null;
    }
}
