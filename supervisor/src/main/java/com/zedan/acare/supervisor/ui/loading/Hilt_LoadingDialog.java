...
public abstract class Hilt_LoadingDialog extends DialogFragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_LoadingDialog(int contentLayoutId) {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((LoadingDialog_GeneratedInjector) generatedComponent()).injectLoadingDialog((LoadingDialog) UnsafeCasts.unsafeCast(this));
        }
    }
